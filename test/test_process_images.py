...
TRANSCRIBE_BARCODES = 'Y'  # Set to 'Y' or 'N'
TRANSCRIBE_TAXONOMY = 'Y'  # Set to 'Y' or 'N'
...
LABEL_MODEL_VERSION = 4  # Adjust the version as needed!
MASK_MODEL_ENDPOINT = 'bugmasker-tigerbeetle'
MASK_MODEL_VERSION = 11  # Adjust the version as needed!
PIN_MODEL_ENDPOINT = 'pinmasker'
PIN_MODEL_VERSION = 5  # Adjust the version as needed!
...
def run_step(step, directories, args):
    ...
    if step == 'resize_drawers':
        ...
        merge_data(
            ...
            os.path.join(directories['tray_level'], 'taxonomy.csv'),
            os.path.join(directories['tray_level'], 'unit_barcodes.csv'),
            os.path.join(directories['EMu_codes'], 'emu_geocodes.csv'),
            output_base_path
        )
