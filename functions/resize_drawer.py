...
def resize_image(args: Tuple[str, str, Set[str], int, int]) -> bool:
    ...
    try:
        ...
        print(f"\rProcessing image {current}/{total}", 
              end="", flush=True)
        return True
...
def resize_drawer_images(input_dir: str, output_dir: str) -> None:
    """
    Resize all images in input_dir to max 1000px dimension and save to output_dir
    """
